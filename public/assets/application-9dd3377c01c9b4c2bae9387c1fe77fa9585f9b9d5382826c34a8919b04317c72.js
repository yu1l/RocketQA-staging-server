...
(function() {
  $(function() {
      ...
      $.ajax({
        ...
        success: function(msg) {
          if (msg.status === 'success') {
            ...
            return $('#subscribe-error').css('display', 'block');
          }
        }
      });
      return false;
    ...
    $('figure').imagesLoaded(function() {
      ...
      return $('#workflow').css('height', $('figure').height());
    });
    $('#video').click(function() {
      ...
      return $('#video').parent().addClass('is-active');
    });
    $('#screenshot').click(function() {
      ...
      return $('#screenshot').parent().addClass('is-active');
    });
